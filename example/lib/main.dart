...
import 'package:flutterpluginwework/flutterpluginwework.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    initPlatformState();
    Flutterpluginwework.register(APPID, SCHEMA, AGENTID);
    _result = 'no result';
    print('inited');
  }
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await Flutterpluginwework.platformVersion;
  ...
  //   try {
  //     var result = await Flutterpluginwework.share(arguments);
  ...
  void _checkInstalled () async {
    var result = await Flutterpluginwework.isWecomeInstalled();
    print(result);
  }
  
  void _login () async {
    var result = await Flutterpluginwework.login({
      'state': WWSTATE,
    });
  ...
  void _openWecome () async {
    var result = await Flutterpluginwework.openWecome();
  }
...
//     if (!mounted) return;
//
//     _calculateResult = await Flutterpluginwework.calculate(10, 10);
//
//     setState(() {
//       _platformVersion = platformVersion;
//     });
